...
`N = 50,000`  ·  seed `0`  ·  12 null replicates per model ·  13s
...
| det: no factor <= 47 (unthinned) | 6,928 | 0.13856 |
...
|---|---|---|---|---|---|---|
| **SURVIVES** | `crt_lattice` | crt_independence | 0.708 | -13.323 | -6.772 | 3.486 |
| **SURVIVES** | `factor_embed` | frac_at_origin | 0.996 | 196.872 | 92.580 | 18.389 |
| **SURVIVES** | `pair_spectrum` | pair_corr_dispersion | 1.455 | -32.755 | 15.134 | -16.767 |
| **SURVIVES** | `polar_radian` | ang_dispersion_710 | 1.037 | -0.620 | 0.967 | 8.268 |
| **SURVIVES** | `prime_gaps` | gap_lag1_corr | -0.072 | -6.770 | -3.398 | 3.265 |
| **DEEP-COPRIMALITY** | `count_fluctuation` | fluct_dispersion_small_L | 0.578 | -7.272 | -5.546 | 2.643 |
| **DEEP-COPRIMALITY** | `modular_grid` | reduced_dispersion | 0.181 | -14.765 | -6.440 | 0.982 |
| **DEEP-COPRIMALITY** | `ulam_spiral` | diag_dispersion | 1.547 | -7.442 | 5.396 | -1.305 |
| **COPRIMALITY** | `factor_shift` | mean_basis_exponent_shift | 3.858 | 65.797 | 0.354 | -0.572 |
| **COPRIMALITY** | `sacks_spiral` | local_ang_dispersion | 0.990 | -8.485 | 0.032 | -0.084 |
| **ARTIFACT** | `modular_walk` | walk_drift_mean | 0.416 | -2.494 | -2.912 | 1.455 |
...
**Critique.** SURVIVES - crt_independence=0.708 (z: Cramer -13.323, sieved -6.772, rough 3.486). Not reproduced by matched-density randomness, by small-factor avoidance, or by a deterministic set avoiding every prime up to 47. Needs a mechanism. Real is ABOVE the null - more clumped.
...
|---|---|---|---|---|---|---|---|
| `crt_independence` | 0.708 | 1.616±0.068 | -13.323 | 1.020±0.046 | -6.772 | 0.547 | 3.486 |
| `crt_independence_max` | 0.832 | 1.768±0.085 | -11.050 | 1.136±0.057 | -5.328 | 0.742 | 1.581 |
| `crt_independence_unreduced` | 0.426 | 0.895±0.029 | -16.040 | 0.562±0.024 | -5.683 | 0.271 | 6.504 |
| `crt_indep_11_13` | 0.555 | 1.590±0.178 | -5.828 | 0.967±0.154 | -2.681 | 0.419 | 0.889 |
| `crt_indep_13_17` | 0.642 | 1.626±0.194 | -5.071 | 1.014±0.134 | -2.774 | 0.412 | 1.707 |
...
**Critique.** SURVIVES - frac_at_origin=0.996 (z: Cramer 196.872, sieved 92.580, rough 18.389). Not reproduced by matched-density randomness, by small-factor avoidance, or by a deterministic set avoiding every prime up to 47. Needs a mechanism. Real is ABOVE the null - more clumped.
...
| statistic | real | Cramér | z | sieved | z | rough | z |
|---|---|---|---|---|---|---|---|
| `frac_at_origin` | 0.996 | 0.127±0.00442 | 196.872 | 0.551±0.00481 | 92.580 | 0.908 | 18.389 |
| `mean_basis_exponent` | 0.0039 | 2.509±0.019 | -129.161 | 0.595±0.00562 | -105.159 | 0.095 | -16.120 |
| `mean_v2` | 0.000195 | 0.997±0.013 | -76.219 | 0.000195±1.93e-06 | -0.140 | 0.000144 | 26.156 |
...
**Critique.** SURVIVES - pair_corr_dispersion=1.455 (z: Cramer -32.755, sieved 15.134, rough -16.767). Not reproduced by matched-density randomness, by small-factor avoidance, or by a deterministic set avoiding every prime up to 47. Needs a mechanism. Real is BELOW the null - more even/less clumped.
...
| statistic | real | Cramér | z | sieved | z | rough | z |
|---|---|---|---|---|---|---|---|
| `pair_corr_dispersion` | 1.455 | 69.259±2.070 | -32.755 | 0.444±0.067 | 15.134 | 2.574 | -16.767 |
| `pair_corr_spread` | 0.038 | 0.176±0.00213 | -64.879 | 0.022±0.00182 | 8.560 | 0.037 | 0.345 |
| `deep_sieve_ratio` | 1.059 | 1.143±0.00708 | -11.835 | 1.000±0.0037 | 16.034 | 1.064 | -1.243 |
| `pair_corr_max` | 1.097 | 0.802±0.012 | 24.393 | 1.058±0.011 | 3.780 | 1.092 | 0.476 |
| `pair_corr_min` | 0.948 | 0.232±0.00871 | 82.231 | 0.942±0.00791 | 0.826 | 0.964 | -2.009 |
...
**Critique.** SURVIVES - ang_dispersion_710=1.037 (z: Cramer -0.620, sieved 0.967, rough 8.268). Not reproduced by matched-density randomness, by small-factor avoidance, or by a deterministic set avoiding every prime up to 47. Needs a mechanism. Real is ABOVE the null - more clumped.
...
| statistic | real | Cramér | z | sieved | z | rough | z |
|---|---|---|---|---|---|---|---|
| `ang_dispersion_allint_6` | 0.491 | 0.927±0.748 | -0.583 | 0.553±0.320 | -0.196 | 0.200 | 0.909 |
| `ang_dispersion_6` | 0.843 | 1.679±1.154 | -0.725 | 0.868±0.506 | -0.050 | 0.811 | 0.062 |
| `ang_dispersion_allint_44` | 1.624 | 0.849±0.183 | 4.242 | 1.218±0.172 | 2.358 | 1.081 | 3.153 |
| `ang_dispersion_44` | 1.144 | 2.488±0.401 | -3.349 | 0.969±0.206 | 0.851 | 0.439 | 3.428 |
| `ang_dispersion_allint_100` | 2.132 | 0.862±0.139 | 9.164 | 2.352±0.193 | -1.134 | 2.693 | -2.900 |
| `ang_dispersion_100` | 1.011 | 4.993±0.538 | -7.401 | 1.003±0.157 | 0.050 | 0.450 | 3.564 |
| `ang_dispersion_allint_710` | 11.406 | 0.891±0.057 | 183.641 | 11.357±0.133 | 0.368 | 14.790 | -25.408 |
| `ang_dispersion_710` | 1.037 | 1.083±0.073 | -0.620 | 0.964±0.076 | 0.967 | 0.410 | 8.268 |
...
**Critique.** SURVIVES - gap_lag1_corr=-0.072 (z: Cramer -6.770, sieved -3.398, rough 3.265). Not reproduced by matched-density randomness, by small-factor avoidance, or by a deterministic set avoiding every prime up to 47. Needs a mechanism. Real is ABOVE the null - more clumped.
...
| statistic | real | Cramér | z | sieved | z | rough | z |
|---|---|---|---|---|---|---|---|
| `gap_var_ratio` | 0.588 | 0.927±0.037 | -9.257 | 0.635±0.017 | -2.807 | 0.445 | 8.639 |
| `gap_lag1_corr` | -0.072 | 0.015±0.013 | -6.770 | -0.019±0.016 | -3.398 | -0.124 | 3.265 |
| `frac_gap_div6` | 0.404 | 0.123±0.00663 | 42.469 | 0.402±0.00522 | 0.464 | 0.373 | 5.915 |
| `frac_gap_even` | 1.000 | 0.471±0.00865 | 61.125 | 1.000±1.93e-06 | 0.140 | 1.000 | -26.155 |
| `max_gap_over_mean` | 7.391 | 9.350±1.436 | -1.364 | 7.278±0.977 | 0.116 | 4.988 | 2.459 |

## Multiscale count-fluctuation map  ·  DEEP-COPRIMALITY

*at any scale, does the set clump or resist clumping along the number line?*

![count_fluctuation](count_fluctuation.png)

**Critique.** DEEP-COPRIMALITY - fluct_dispersion_small_L=0.578 (z: Cramer -7.272, sieved -5.546, rough 2.643). Beats avoidance of 2,3,5,7 but not avoidance of every prime up to 47. Still divisibility, just deeper - and the deterministic rough set has no primality in it at all. Real is BELOW the null - more even/less clumped.
...
| statistic | real | Cramér | z | sieved | z | rough | z |
|---|---|---|---|---|---|---|---|
| `fluct_dispersion` | 0.416 | 1.565±0.249 | -4.617 | 0.944±0.137 | -3.853 | 0.234 | 1.332 |
| `fluct_dispersion_small_L` | 0.578 | 1.604±0.141 | -7.272 | 0.940±0.065 | -5.546 | 0.406 | 2.643 |
| `fluct_dispersion_large_L` | 0.264 | 1.522±0.492 | -2.556 | 0.948±0.222 | -3.076 | 0.105 | 0.714 |
| `fluct_slope` | -0.418 | -0.055±0.145 | -2.494 | -0.013±0.101 | -4.017 | -0.649 | 2.298 |
...
**Critique.** DEEP-COPRIMALITY - reduced_dispersion=0.181 (z: Cramer -14.765, sieved -6.440, rough 0.982). Beats avoidance of 2,3,5,7 but not avoidance of every prime up to 47. Still divisibility, just deeper - and the deterministic rough set has no primality in it at all. Real is BELOW the null - more even/less clumped.
...
| statistic | real | Cramér | z | sieved | z | rough | z |
|---|---|---|---|---|---|---|---|
| `reduced_dispersion` | 0.181 | 1.128±0.064 | -14.765 | 0.905±0.112 | -6.440 | 0.070 | 0.982 |
| `max_reduced_dispersion` | 0.361 | 2.526±0.297 | -7.284 | 2.177±0.843 | -2.153 | 0.217 | 0.171 |
| `reduced_dispersion_allint_pool` | 0.098 | 0.788±0.050 | -13.910 | 0.499±0.060 | -6.656 | 0.027 | 1.179 |
| `all_class_dispersion` | 243.655 | 0.815±0.061 | 4e+03 | 237.084±2.382 | 2.758 | 328.792 | -35.735 |
| `reduced_dispersion_k12` | 0.175 | 0.761±0.456 | -1.285 | 0.983±0.828 | -0.976 | 0.015 | 0.193 |
| `reduced_dispersion_k30` | 0.153 | 0.935±0.509 | -1.536 | 0.991±0.337 | -2.489 | 0.017 | 0.402 |
| `reduced_dispersion_k47` | 0.252 | 1.639±0.284 | -4.890 | 0.922±0.156 | -4.296 | 0.176 | 0.486 |

## Ulam square spiral  ·  DEEP-COPRIMALITY

*do the set's members line up on the spiral's diagonals?*

![ulam_spiral](ulam_spiral.png)

**Critique.** DEEP-COPRIMALITY - diag_dispersion=1.547 (z: Cramer -7.442, sieved 5.396, rough -1.305). Beats avoidance of 2,3,5,7 but not avoidance of every prime up to 47. Still divisibility, just deeper - and the deterministic rough set has no primality in it at all. Real is ABOVE the null - more clumped.
...
| statistic | real | Cramér | z | sieved | z | rough | z |
|---|---|---|---|---|---|---|---|
| `diag_dispersion_allint` | 14.687 | 0.925±0.035 | 397.163 | 14.422±0.188 | 1.409 | 19.311 | -24.639 |
| `diag_dispersion` | 1.547 | 3.515±0.264 | -7.442 | 1.127±0.078 | 5.396 | 1.649 | -1.305 |
| `anti_dispersion_allint` | 13.341 | 0.925±0.057 | 216.181 | 13.022±0.137 | 2.318 | 17.668 | -31.508 |
| `anti_dispersion` | 1.517 | 1.834±0.167 | -1.901 | 1.092±0.084 | 5.043 | 1.787 | -3.197 |
| `row_dispersion_allint` | 1.943 | 1.044±0.088 | 10.175 | 1.924±0.112 | 0.168 | 1.794 | 1.324 |
| `row_dispersion` | 1.087 | 5.048±0.514 | -7.705 | 1.229±0.127 | -1.119 | 0.801 | 2.250 |
| `col_dispersion_allint` | 1.783 | 1.002±0.104 | 7.531 | 2.077±0.140 | -2.097 | 1.961 | -1.269 |
| `col_dispersion` | 1.058 | 5.380±0.394 | -10.981 | 1.261±0.148 | -1.369 | 0.708 | 2.356 |
| `diag_over_row` | 1.424 | 0.702±0.086 | 8.417 | 0.922±0.081 | 6.226 | 2.058 | -7.886 |
...
**Critique.** COPRIMALITY - mean_basis_exponent_shift=3.858 (z: Cramer 65.797, sieved 0.354, rough -0.572). Beats random integers but not integers that merely avoid factors 2,3,5,7. The definition of a prime showing through, not distributional structure. Real is ABOVE the null - more clumped.
...
| statistic | real | Cramér | z | sieved | z | rough | z |
|---|---|---|---|---|---|---|---|
| `mean_v2_of_shift` | 1.991 | 0.998±0.016 | 63.452 | 1.994±0.022 | -0.157 | 1.998 | -0.310 |
| `mean_basis_exponent_shift` | 3.858 | 2.506±0.021 | 65.797 | 3.847±0.031 | 0.354 | 3.875 | -0.572 |
| `frac_shift_div6` | 0.498 | 0.166±0.00513 | 64.778 | 0.501±0.00606 | -0.471 | 0.500 | -0.286 |
| `v2_shape_dispersion` | 576.502 | 1.945±0.918 | 625.844 | 576.385±6.783 | 0.017 | 777.943 | -29.698 |
...
**Critique.** COPRIMALITY - local_ang_dispersion=0.990 (z: Cramer -8.485, sieved 0.032, rough -0.084). Beats random integers but not integers that merely avoid factors 2,3,5,7. The definition of a prime showing through, not distributional structure. Real is BELOW the null - more even/less clumped.
...
| statistic | real | Cramér | z | sieved | z | rough | z |
|---|---|---|---|---|---|---|---|
| `ang_dispersion_allint_360` | 1.180 | 0.899±0.064 | 4.419 | 0.921±0.053 | 4.920 | 0.970 | 3.979 |
| `ang_dispersion_360` | 1.278 | 2.089±0.086 | -9.405 | 0.978±0.052 | 5.731 | 1.052 | 4.331 |
| `ang_dispersion_allint_720` | 1.062 | 0.880±0.038 | 4.809 | 0.880±0.033 | 5.473 | 0.898 | 4.921 |
| `ang_dispersion_720` | 1.234 | 2.184±0.081 | -11.791 | 0.999±0.048 | 4.951 | 1.084 | 3.152 |
| `local_ang_dispersion` | 0.990 | 2.189±0.141 | -8.485 | 0.988±0.059 | 0.032 | 0.995 | -0.084 |
...
**Critique.** ARTIFACT - walk_drift_mean=0.416 (z: Cramer -2.494, sieved -2.912, rough 1.455). Every null reproduces it; whatever you can see is the encoding drawing itself, not the primes.
...
| statistic | real | Cramér | z | sieved | z | rough | z |
|---|---|---|---|---|---|---|---|
| `drift_k8` | 0.671 | 0.740±0.324 | -0.211 | 0.781±0.471 | -0.233 | 0.211 | 0.977 |
| `drift_k9` | 0.429 | 0.920±0.655 | -0.751 | 0.872±0.354 | -1.254 | 0.216 | 0.601 |
| `drift_k11` | 0.452 | 1.386±0.697 | -1.339 | 0.709±0.366 | -0.700 | 0.125 | 0.893 |
| `drift_k13` | 0.400 | 1.122±0.840 | -0.860 | 0.835±0.510 | -0.851 | 0.213 | 0.366 |
| `drift_k16` | 0.149 | 0.891±0.367 | -2.020 | 1.021±0.613 | -1.421 | 0.235 | -0.139 |
| `drift_k25` | 0.390 | 1.088±0.796 | -0.877 | 0.974±0.503 | -1.163 | 0.066 | 0.644 |
| `drift_k29` | 0.419 | 0.969±0.512 | -1.076 | 0.833±0.327 | -1.266 | 0.288 | 0.399 |
| `walk_drift_mean` | 0.416 | 1.017±0.241 | -2.494 | 0.861±0.153 | -2.912 | 0.193 | 1.455 |
| `walk_drift_max` | 0.671 | 1.989±0.533 | -2.474 | 1.555±0.380 | -2.325 | 0.288 | 1.007 |
