...
"""Blind visual search for structure in the primes.
  ...
  python3 run.py                       # iteration 1, N = 100,000
  python3 run.py --quick               # fast smoke test, N = 20,000, no UMAP
...
def main() -> None:
    ...
    if a.quick:
        a.N, a.reps, a.no_umap = min(a.N, 20_000), 6, True
